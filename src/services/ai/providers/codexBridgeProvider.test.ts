...
import { createCodexBridgeProvider } from "@/services/ai/providers/codexBridgeProvider";

describe("createCodexBridgeProvider", () => {
  ...
  it("aborts long-running requests with a clear timeout error", async () => {
    ...
    const provider = createCodexBridgeProvider("codex-default", "http://127.0.0.1:8765");
